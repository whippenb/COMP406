...
Also, some writers put pointless filler in their paragraphs that doesn't
go anywhere, or even worse, bury the point in the middle of the paragraph.
But, good writers understand that to get people to read their work, they
must make their work easy to skim.
